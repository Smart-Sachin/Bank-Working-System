                    ...
                    <center>
                        <div class="account_create">
                           <%
                        		...
                        		out.println("Account Description : "+ub.getAccType()+"<br>");
                        		out.println("Total Balance       : "+ub.getBalance());
                        	%>
                           <hr>
                           Date &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Datails &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Debit &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Credit &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Balance <br>
                           <hr>
                          20 FEB 2023 &nbsp;&nbsp;&nbsp; TRANSFER TO 5555 &nbsp;&nbsp;&nbsp; 1000.00 &nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp; 4500.27
                           <hr>
                        </div> 
                    </center>              
                </div>
